...
module.exports.rmapsRedirectInterceptor = ($location, $rootScope) ->
...
module.exports.rmapsAlertInterceptor = ($rootScope, $q, rmapsevents) ->
  defineNull = (value) ->
...
module.exports.rmapsLoadingIconInterceptor = ($q, rmapsSpinner) ->
  'request': (request) ->
...
module.exports.pushInterceptors = ($httpProvider) ->
