DROP TABLE IF EXISTS normal_deed_data;
CREATE TABLE normal_deed_data (
...
CREATE TRIGGER update_modified_time_normal_deed_data
  BEFORE UPDATE ON normal_deed_data
  FOR EACH ROW EXECUTE PROCEDURE update_rm_modified_time_column();

CREATE UNIQUE INDEX ON normal_deed_data (data_source_id, data_source_uuid);
