...
apiBaseSourcemap = "#{apiBase}/sourcemap"
...
module.exports =
  ...
  account_use_types:
    ...
    edit: "#{apiBaseAccountUseTypes}/edit/:id"
    create: "#{apiBaseAccountUseTypes}/create"
  config:
  ...
  sourcemap:
    apiBase: apiBaseSourcemap
    get: "#{apiBaseSourcemap}/:fileName"
